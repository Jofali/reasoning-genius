...
class App extends Component {
  ...
  stepTo() {
    ...
    this.timer = setTimeout( () => {
      ...
      {
        case 0:
          this.setState({ content: <Begin />, btnClass: "btn-game btn-game-begin-status", statebtnContent: "开始推理" })
          break;
        case 1:
          this.setState({ content: <Partwrap />, btnClass: "btn-game btn-game-end-status", statebtnContent: "开始推理" })
          break;
        default:
          this.setState({ content: <Begin />, btnClass: "btn-game btn-game-begin-status", statebtnContent: "开始推理" })
      }
