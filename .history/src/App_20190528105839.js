          ...
          <CSSTransition
            ...
            >
              <div className="App-wrap">
                { this.state.end ? <End /> : this.state.content }
                { this.state.end && this.state.suspectName === "shenmiren" } ? <button disabled className={this.state.btnClass} onClick={this.stepTo}>{this.state.btnContent}</button> : <button className={this.state.btnClass} onClick={this.stepTo}>{this.state.btnContent}</button>
              </div>
          </CSSTransition>
        </div>
    );
