...
class App extends Component {
  constructor(props) {
    super(props);
    this.state = {
      content: <Part1 data={this} onData={ this.handleTitleStatusChange } />,
      arr: arrNext,
      arrStatus: "next",
      maxPartNum: 1,
      showPart: true,
  ...
  stepTo() {
    ...
    this.timer = setTimeout( () => {
      ...
      {
        case 0:
          this.setState({ content: <Part1 data={this} onData={ this.handleTitleStatusChange } /> })
          this.setState({ arrStatus: "next" });
          break;
        case 1:
          this.setState({ content: <Part2 onData={ this.handleTitleStatusChange } /> })
          this.setState({ arrStatus: "prev" })
          break;
        default:
          this.setState({ content: <Part1 onData={ this.handleTitleStatusChange } /> })
      }
      this.setshow(true);
    }, 300);
  ...
  handleTitleStatusChange(status) {
    //this.setState({ titleStatus: status });
    console.log(this)
  }
