  ...
  constructor(props) {
    ...
    switch(props.data.status)
    {
      ...
      case "identifySuspectNeiKuNan":
        this.setState({ word: play.part2.identifySuspect.neiKuNan[0] });
        break;
      case "identifySuspectMoXianSheng":
        this.setState({ word: play.part2.identifySuspect.moXianSheng[0] });
        break;
      case "identifySuspectShenMiRen":
        this.setState({ word: play.part2.identifySuspect.shenMiRen[0] });
        break;
    }
