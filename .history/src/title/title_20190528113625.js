...
class Title extends React.Component {
  ...
  render() {
    ...
    console.log(his.state.word);
    return (
      <div>
        <div className={ this.props.data.statusClass } onClick={ () => this.nextTopic(this.state.topicNum, this.state.word.length, this.props.data.status) }>
